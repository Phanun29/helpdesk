                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?php if (isset($canAddStation) && $canAddStation) : ?>
                            <a href="add_users.php" class="btn btn-primary ml-2"><i class="fas fa-plus"></i> <b>Create New User</b></a>
                        <?php endif; ?>
                        <!-- <a href="add_users.php" class="btn btn-primary"><i class="fas fa-plus"></i> <b>Create New User</b></a> -->
                            ...
                            <tbody>
                                ...
                                if ($user_result->num_rows > 0) {
                                    while ($row = $user_result->fetch_assoc()) {
                                        ...
                                        echo "<td>" . $row['rules_name'] . "</td>"; // Display rules_name instead of rules_id
                                        if ($row['status'] === '1') {
                                            echo "<td>active</td>";
                                        } else {
                                            echo "<td>Inactive</td>";
                                        ...
                                        if ($canEditStation == 0 &  $canDeleteStation == 0) {
                                            ...
                                            if ($canEditStation) {
                                                echo "<a href='edit_user.php?id=" . $row['users_id'] . "' class='btn btn-primary'><i class='fa-solid fa-pen-to-square'></i></a> ";
                                            }

                                            // Delete button if user has permission
                                            if ($canDeleteStation) {
                                                echo "<a href='delete_user.php?id=" . $row['users_id'] . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this item?\");'><i class='fa-solid fa-trash'></i></a>";
                                            }
                                            echo "</td>";
                                        }
                                        echo "</tr>";
