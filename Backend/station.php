...
$user_query = "SELECT * FROM tbl_station ORDER BY id DESC LIMIT $offset, $records_per_page";


$user_result = $conn->query($user_query);
$total_query = "SELECT COUNT(*) as total FROM tbl_station ";
          ...
          <div class="card-header row">
            <div class="col-sm-6">
              ...
              <?php if (isset($canAddStation) && $canAddStation) : ?>
                <a href="create_station.php" class="btn btn-primary ml-2">Add Station</a>
              <?php endif; ?>
            </div>
            <div class="col-sm-6">
              <div class="input-group input-group-sm float-end mt-1" style="width: 250px;">
                <input type="text" id="table_search" name="table_search" style="height: 45px;" class="form-control float-right" placeholder="Search">
